...
N               = ceil(6300/18)*18+1; %number of grid points in k-space
...
f               = 51e6;         %real excitation frequency
...
A_ion           = [1       2      ];  %mass number of ions
Z_ion           = [1       1      ];  %charge of ions
conc_ion        = [0.05    0.95   ];  %concentration relative to ne
